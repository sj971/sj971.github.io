...
I built on prior attempts to discover novel risk factors for diabetes, by extending the search for novel risk factors to the BRFSS dataset. By comparing the performance of a standard model, which included known predictors such as blood pressure and cholesterol, to performance of a model that included broad lifestyle and behavioral factors, I concluded that lifestyle factors alone (e.g., healthy eating behaviors, exercise) do not provide much improvement on diabetes prediction relative to the standard model. While some improvement was seen with the extended model, this was likely driven by responses related to general health. The question of whether a more detailed treatment of lifestyle and behavioral factors, and their interactions, could improve diabetes prediction remains open.
